...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
        ...
        if self.testing:
            ...
            #self.epsilon = math.pow(self.constant_alpha, self.num_trials)
            self.epsilon = math.exp(-self.alpha * self.num_trials) #math.cos(self.alpha * self.num_trials)
            self.num_trials += 1
